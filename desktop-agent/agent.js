...
/**
 * MargDarshak Desktop Agent — Watched Folder Auto-Registration
 *
 * Monitors a folder for new media files and automatically registers them
 * on the MargDarshak blockchain. Works with any camera, any software, any workflow.
 *
 * Usage:
...
const API_BASE = process.env.MargDarshak_API || 'https://MargDarshak-app.vercel.app/api';
const API_KEY = process.env.MargDarshak_API_KEY || 'desktop-agent';
...
console.log('  \x1b[1m  MargDarshak Desktop Agent\x1b[0m');
