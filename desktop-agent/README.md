# MargDarshak Desktop Agent

Watches a folder and automatically registers any new media file on the MargDarshak blockchain.
...
- `MargDarshak_API` — API endpoint (default: https://MargDarshak-app.vercel.app/api)
- `MargDarshak_API_KEY` — API key for registration
