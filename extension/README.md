# MargDarshak - Media Verifier Chrome Extension

Verify the authenticity of any image against the MargDarshak blockchain directly from your browser.
...
2. Select **"Verify with MargDarshak"** from the context menu
3. The extension computes the image's SHA-256 hash and checks it against the MargDarshak blockchain
...
- The hash is sent to the MargDarshak verification API at `https://hackathon-six-eosin.vercel.app/api/verify`
